...
(async () => {
  ...
  await fs.writeFile("fibromyalgia-and-generalized-pain-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("fibromyalgia-and-generalized-pain-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
